...
def draw_and_save(image_path, bbox, label, conf, output_path="output.jpg"):
    """
    Draw bounding box on the image and save it for testing.
    """
...
if __name__ == '__main__':
    ...
    # Save result for testing if a posture was detected
    if score > 0:
        draw_and_save(img_path, bbox, label, score)
